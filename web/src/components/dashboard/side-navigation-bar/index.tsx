...
export default function SideNavigationBar() {
  ...
  return (
    <nav className="fixed inset-y-0 start-0 flex w-full max-w-[8rem] flex-col border-e-[0.5px] border-gray-300 py-m-l">
      <section className="flex flex-grow-[8] flex-col justify-center gap-s-m">
        ...
        <LinkItem
          ...
          icon={faChartSimple}
        />
        <LinkItem title={t("ad-center")} href="/ad-center" icon={faBullhorn} />
      ...
      <section className="flex flex-grow-[2] flex-col justify-center gap-s-m border-t-[0.5px] border-gray-300">
        <LinkItem title={t("settings")} href="/settings" icon={faCog} />
        <SignOutButton />
      </section>
    </nav>
  );
