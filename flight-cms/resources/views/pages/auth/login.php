      ...
      <form action="/login" method="POST">
        <div class="grid gap-y-4">
          <div>
            ...
            <?php if (error('email')): ?>
                <p class="text-xs text-red-600 mt-2" id="email-error"><?= message('email') ?></p>
            <?php endif; ?>
          </div>
          ...
          <div>
            ...
            <?php if (error('password')): ?>
                <p class="text-xs text-red-600 mt-2" id="password-error"><?= message('password') ?></p>
            <?php endif; ?>
            <?php if (error('login')): ?>
                <p class="text-xs text-red-600 mt-2"><?= message('login') ?></p>
            <?php endif; ?>
          </div>
