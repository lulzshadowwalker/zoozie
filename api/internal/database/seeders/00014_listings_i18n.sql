...
VALUES
    ...
    (-42070, 'en', -42069, 'لوريم إيبسوم هو ببساطة نص شكلي (بمعنى أن الغاية هي الشكل وليس المحتوى) ويُستخدم في صناعات المطابع ودور النشر.كان لوريم إيبسوم ولايزال المعيار للنص الشكلي منذ القرن الخامس عشر عندما قامت مطبعة مجهولة برص مجموعة من الأحرف بشكل عشوائي أخذتها من نص ، لتكون هذه الأحرف هي بداية نص لوريم إيبسوم.مازالت النسخة الأولى من لوريم إيبسوم تستخدم بشكل متنوع في مجالات النصوص الشكلية المختلفة'); 
-- +goose StatementEnd
